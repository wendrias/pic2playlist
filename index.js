...
async function getImageData(imgFile) {
    ...
    //COLORS
    const [colorResult] = await client.imageProperties(fileName);
    ...
    //FACE
    const [faceResult] = await client.faceDetection(fileName);
...
const generateTitle = (colors, landmarks, labels) => {
